...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default='train_test', choices=['train', 'test', 'train_test', 'inference','yolo_inference','vedio'])
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        if args.inference_file is None:
            raise ValueError('Inference file not provided. Please pass a valid inference file for inference')
        yolo_infer('E:\mehisen\emotic-master/assets/Screenshot.png')
